  ...
  return (
    <div className="relative">
      ...
      >
        {projects.map((p, i) => (
          <SwiperSlide key={i}>
            <div className="group relative h-72 overflow-hidden rounded-[1.5rem] border border-line bg-surface sm:h-80">
              <Image
                src={p.img}
                alt={p.title}
                fill
              ...
              <span className="absolute left-5 top-5 rounded-full bg-foreground px-3 py-1 text-[11px] font-semibold text-white">
                {p.tag}
              </span>
